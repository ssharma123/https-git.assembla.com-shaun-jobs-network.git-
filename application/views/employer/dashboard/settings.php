        ...
        */
        ...
        <div>
            ...
            <div class="ng-binding">
                <strong>Email:</strong> <span id="changed_email_txt"><?php echo (isset($employer['email'])) ? $employer['email'] : ""; ?> </span> <a href="javascript:void(0);" id="change_email_link">Change Email</a>
                <br>
...
//        }
    ...
    $("#update_settings").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: SITE_URL+"employee_dashboard/update_settings",
            dataType: "json",
            data: {
    ...
    $("#save_email_change").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: SITE_URL+"employee_dashboard/update_employer_emails",
            dataType: "json",
            data: {
    ...
    $("#save_password_change").click(function(){
        ...
        $.ajax({
            type: "POST",
            url: SITE_URL+"employee_dashboard/update_employer_password",
            dataType: "json",
            data: {
