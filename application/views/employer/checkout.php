        ...
        <div class="row">
            ...
            <form class="form-horizontal ng-pristine ng-valid" id="paypal_checkout_form" method="post" action="<?php echo site_url('employer_checkout/checkout_process'); ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                      <select id="country_code" name="country_code" required class="form-control">
                            ...
                            <option value="US" selected="selected">UNITED STATES</option><option value="UM">UNITED STATES MINOR OUTLYING ISLANDS</option><option value="UY">URUGUAY</option><option value="UZ">UZBEKISTAN</option><option value="VU">VANUATU</option><option value="VE">VENEZUELA</option><option value="VN">VIET NAM</option><option value="VG">VIRGIN ISLANDS, BRITISH</option><option value="VI">VIRGIN ISLANDS, U.S.</option><option value="WF">WALLIS AND FUTUNA</option><option value="EH">WESTERN SAHARA</option><option value="ZM">ZAMBIA</option><option value="ZM">ZAMBIA</option>
                        </select>
                  </div>
                </div>
                ...
                <div class="text-center" style="padding-top: 20px;">
                    <button type="submit" class="btn btn-primary btn-lg">Checkout with Paypal</button>
                    <br>
                </div>
