        ...
        <form class="form-horizontal ng-pristine ng-valid" role="form" id="signupForm2" action="<?php echo site_url('employer/signup/2'); ?>" method="post">
            ...
            <div class="form-group b-form b-street">
                ...
                <div class="col-sm-8">
                    ...
                    <input type="text" class="form-control ng-pristine ng-valid" placeholder="Address 2" name="facility_address" id="facility_address" required>
                </div>
            </div>
            <div class="form-group b-form">
                <div class="col-sm-4"></div>
            ...
            <div class="form-group b-form">
                ...
                <div class="col-sm-4">
                 ...
                 <div class="col-sm-4">
                    <label class="col-sm-12 control-label" for="facility_zipCode">Closest Metropolitan City</label>
                    <input type="number" class="form-control ng-pristine ng-valid" name="facility_zipCode" id="facility_zipCode" required min="1" max="99999"  placeholder="">
                </div>
            ...
            <div class="form-group b-form">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" placeholder="First" class="form-control ng-pristine ng-valid" id="billing_name" name="billing_name" required placeholder="">

                </div>
                <div class="col-sm-4">
                    <!--<label class="col-sm-4 control-label" for="billingName"></label>-->
                    <input type="text" placeholder="Last" class="form-control ng-pristine ng-valid" id="billing_name" name="billing_name" required placeholder="">
                </div>
